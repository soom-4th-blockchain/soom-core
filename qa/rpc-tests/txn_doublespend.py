...
class TxnMallTest(BitcoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 12,500 SOOM:
        ...
        # First: use raw transaction API to send 12400 SOOM to node1_address,
        # but don't broadcast:
        ...
        # Node0's balance should be starting balance, plus 500SOOM for another
        ...
        # Node0's total balance should be starting balance, plus 1000SOOM for
