...
from test_framework.test_framework import SoomTestFramework
...
class AutoInstantSendTest(SoomTestFramework):
    def __init__(self):
    ...
    def run_test(self):
        # make sure gateways are synced
        sync_gateways(self.nodes)
        ...
        self.enforce_gateway_payments()  # required for bip9 activation
