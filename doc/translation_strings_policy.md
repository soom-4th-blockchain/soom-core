...
This document provides guidelines for internationalization of the Soom Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `soom_en.ts` remains unchanged.
