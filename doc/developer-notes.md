...
Soom Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 16099.
...
However, in open source software such as Soom Core, where everyone uses
...
pay attention to for reviewers of Soom Core code.
