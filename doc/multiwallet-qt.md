...
Only requiring some minor changes is soom.cpp.
...
Changes to soom.cpp
----------------------
soom.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
