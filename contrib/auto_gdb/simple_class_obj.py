...
simple_types = ["CGateway", "CGatewayVerification",
                "CGatewayBroadcast", "CGatewayPing", "CGatewayMan",
                "CTransaction", "CMutableTransaction", "CGatewayPayments",
                "CGatewayPaymentVote", "CGatewayBlockPayees",
                "CGatewayPayee", "CInstantSend", "CTxLockRequest",
                "CTxLockVote", "CTxLockCandidate", "COutPoint",
                "COutPointLock", "CSporkManager", "CGatewaySync"]
