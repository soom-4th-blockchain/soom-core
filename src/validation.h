...
//! Discourage users to set fees higher than this amount (in tnSOOMs) per kB
 ...
 */
int32_t ComputeBlockVersion(const CBlockIndex* pindexPrev, const Consensus::Params& params, bool fAssumeGatewayIsUpgraded = false);
