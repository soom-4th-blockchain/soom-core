...
//! -maxtxfee will warn if called with a higher fee than this amount (in tnSOOMs)
 ...
 *  Gateway outbound peers get quarter this delay. */
static const unsigned int INVENTORY_BROADCAST_INTERVAL = 5;  // TODO : need check .hcdo
/** Maximum number of inventory items to send per transmission.
 *  Limits the impact of low-fee transaction floods.
 *  We have 4 times smaller block times in Soom, so we need to push 4 times more invs per 1MB. */
static const unsigned int INVENTORY_BROADCAST_MAX_PER_1MB_BLOCK = 4 * 7 * INVENTORY_BROADCAST_INTERVAL;  // TODO : need check .hcdo
...
/** Absolute maximum transaction fee (in tnSOOMs) used by wallet and mempool (rejects high fee in sendrawtransaction) */
 ...
 */
int32_t ComputeBlockVersion(const CBlockIndex* pindexPrev, const Consensus::Params& params, bool fCheckGatewaysUpgraded = false);
