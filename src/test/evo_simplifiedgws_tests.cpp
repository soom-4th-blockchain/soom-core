...
BOOST_FIXTURE_TEST_SUITE(evo_simplifiedgws_tests, BasicTestingSetup)

BOOST_AUTO_TEST_CASE(simplifiedgws_merkleroots)
{
    std::vector<CSimplifiedGWListEntry> entries;
    for (size_t i = 0; i < 15; i++) {
        CSimplifiedGWListEntry smle;
