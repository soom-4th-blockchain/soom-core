...
extern UniValue gateway(const UniValue& params, bool fHelp);
extern UniValue gatewaylist(const UniValue& params, bool fHelp);
extern UniValue gatewaybroadcast(const UniValue& params, bool fHelp);
extern UniValue gwsync(const UniValue& params, bool fHelp);
