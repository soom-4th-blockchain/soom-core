...
{
    ALL_COINS,
    ONLY_5000, // find gateway outputs including locked ones (use with caution)
};
...
public:
    ...
    int nSentTimes; //times we've sent
...
public:
    ...
    /// Get 5000SOOM output and keys which can be used for the Gateway
    bool GetGatewayOutpointAndKeys(COutPoint& outpointRet, CPubKey& pubKeyRet, CKey& keyRet,const std::string& strTxHash = "", const std::string& strOutputIndex = "");
    ...
    void AutoLockGatewayCollaterals();
