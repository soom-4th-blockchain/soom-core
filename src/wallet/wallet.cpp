...
//#/ start jhhong enable bip69 180803
bool bBIP69Enabled = true;
//#/ end jhhong
/** 
 * Fees smaller than this (in tnsoom) are considered zero fee (for transaction creation)
...
bool CWallet::GetGatewayOutpointAndKeys(COutPoint& outpointRet, CPubKey& pubKeyRet, CKey& keyRet, std::string strTxHash, std::string strOutputIndex)
{
