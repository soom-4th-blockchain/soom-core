...
/** Fees smaller than this (in tnsoom) are considered zero fee (for relaying, mining and transaction creation) */
...
const multimap<string, int> mapUnvalidVout={
...
//	{"25a50f56672496bb22d0bae3daa921ca9c3dc5c8ff25c6b7dccc7141a345a20f", 0},
    ...
    {"3651df627a6d79524d85e10a67d537ecfb5807a29bb0ef9536983732a99bb1ea", 0}, // 25
    
	{"0e15ce64b87bb43333887947497e174caea21d73c4d80030d8a7ac6c5e249f6d", 0},
    ...
    {"112e365ef04e221e53aab125ed6deb1d2a364261b4dba9cb38541a7a72815e7a", 1}, // 30
	
    {"9db39e52c7ab642dda242206e04095e7c18dd4626a48702ab68579fdddb798d7", 1},
    ...
    {"90f1225cfbd22aed3cee811f17b84c81ca2f5e0d7fe656b62f50e80abbe8ccdf", 1}, // 35
	
    {"b360e0c92fe6e5d49bef6d7b4c2e5d7dc2e998b9bb697e7649ed09df26bec41b", 1},
    ...
    {"86c569b3794ae66b86b0a3fd832c532e1997aa6334b3026462e6df866b1e59f4", 1}, // 40
	
    {"8add3357a96e669da4388d76d02af4b480b54d79c14a484dd1e4dedfec2612af", 1},
//	{"d9bf57be190015c02e5f4caa1a55e775bd6ff8003292791b0d091be39f2eb982", 1},
    ...
    {"181f68a2f334e7ab7bedc5742bd1252c66a429cba4e87af16d867b42e522611f", 1}, // 45
	
    {"47f1c8c8c6b5ba3871bd3907a25222530269de377ea79b874ebe4d71656611b9", 1},
	{"00c513694d3fd484645f04b1c86495a43ea0b4b0fa5dc93952ffb1dca95e2c72", 1},
    ...
    {"98a235f0328512b19f1c75e83cfddb861e1d6c678c6701d9faee4eb915bf5261", 1}, // 50
    
	{"5f46d64e86c8f7cf5d2518c8748305ddc5ea98cebe43e141acad4fefa2f048d4", 1},
    {"ffe50590f179c6980ae2e0f051fe7900eea76d7d3993fd4c9de59844d3c71e06", 1},
    ...
    {"7e20bad1c2b09a4ea4f69fb12cf3910e9b7bac88e3df80f3d6f56ecd8b443fd6", 1}, // 55 
    
	{"9375e28dc2fdfc9c377cc4ed264137313ede2ae3ae3bd7cfc92996451f37535d", 1},
    {"9c0571a8d63884a0b3cbe3575b00d8630c1149ab40fade8a69445bbf2913d031", 1},
    ...
    {"204251e192f718f7b4aa910bcab42543af7c1f2687eca24c513fa823266e83d3", 1}, // 60
    
	{"300f7fe43b583a7b612c9a413aff2b43bc0bb5bfdd8a93603a9a585247a4d82d", 1},
    {"62253fabcd1d14403b8e47d5ff80e1fc5828b54978ea0882a733a599a0ba1cb5", 1},
    ...
    {"4efd8bdc84e7531cc60c3d79307e09ec5092e14cc887f20bbf98f2e1974a1898", 1}, // 65
    
	{"a8d5805e58f772ad89aa4fe66cace5de9b6ca8f587a8c3f9cc8af0157c69eaa0", 1},
    {"0f18891440d3a057b342e90085b18c8e13768ce62829bf84255bf6bccad35c50", 1},
    ...
    {"b795fc5d928918e9f51cacad53ef1190e154dee9271a41938f0536674b7e4d30", 1}, // 70
    
	{"9e6585ad61085465cd68883e717dbc6977c9986ca6fc9395cb218d5f2e5ef265", 1},
    {"9c7f1f2712863583ac4e0798a4cf61eeef568fdb62604e89fa50f3a264ef52b7", 1},
    ...
    {"d0262784a108e30f1f573d0850db940a99789656470933468b1185a392bc5ca9", 1}, // 75
    
	{"c83df37ab312913d30a5398772ad9be03b3485d47ed26eefbc0bcf23d99bff72", 1},
    {"28860dcc6c89f4075442591b90ae3233606bc3e88910048383b6f3bd1e618f86", 1},
    ...
    {"28eaa00e811895f886e96b858b2f7e88d64de586fb9ef49cc511244ebec56147", 1}, // 80
    
	{"18c657303af70a237b1431670e6ae9191f5afa6f1a71debc8c4048ddd4c0065d", 1},
    {"1feb4a3e11084f25a6613e33ec3ecd5042021c11f03d4645490382e446d185b4", 1},
    ...
    {"7c8cfdf99f02339fc67e9c97e3ef36c73bfc0ce0e07615b5f4f57352fefe43fe", 1}  // 85
};
...
const string strMessageMagic = "SoomCoin Signed Message:\n";
    ...
    if(Params().NetworkIDString() == CBaseChainParams::MAIN)
    {
        if(banfilter.contains(uint256S(tx.GetHash().GetHex().c_str())))
        {
            for(const auto & mi : mapUnvalidVout){	
                const string strTxhash = mi.first;
...
CAmount GetBlockSubsidy(int nPrevBits, int nPrevHeight, const Consensus::Params& consensusParams)
{
	...
	if(nPrevHeight < 100)
	{
		nSubsidy = 12783820 * COIN;
	}
	else
	{
		nSubsidy = 60.74 * COIN;

		// yearly decline of production by 20% per year, projected ~160M coins max by year 2050+.
...
CAmount GetGatewayPayment(int nHeight, CAmount blockValue)
{
...
int32_t ComputeBlockVersion(const CBlockIndex* pindexPrev, const Consensus::Params& params, bool fAssumeGatewayIsUpgraded)
{
    LOCK(cs_main);
    ...
    for (int i = 0; i < (int)Consensus::MAX_VERSION_BITS_DEPLOYMENTS; i++) {
        ...
        if (vbinfo.check_gw_protocol && state == THRESHOLD_STARTED && !fAssumeGatewayIsUpgraded) {
            CScript payee;
            gateway_info_t gwInfo;
            if (!gwpayments.GetBlockPayee(pindexPrev->nHeight + 1, payee)) {
                // no votes for this block
                continue;
            }
            if (!gwnodeman.GetGatewayInfo(payee, gwInfo)) {
                // unknown gateway
                continue;
            }
        }
...
static bool ConnectBlock(const CBlock& block, CValidationState& state, CBlockIndex* pindex, CCoinsViewCache& view, bool fJustCheck = false)
{
    ...
    // SOOM : MODIFIED TO CHECK GATEWAY PAYMENTS AND FOUNDATION PAYMENTS
    ...
    if (!IsBlockValueValid(block, pindex->nHeight, blockReward, strError)) {
        return state.DoS(0, error("ConnectBlock(SOOM): %s", strError), REJECT_INVALID, "bad-cb-amount");
    }

    if (!IsBlockPayeeValid(block.vtx[0], pindex->nHeight, blockReward)) {
        mapRejectedBlocks.insert(make_pair(block.GetHash(), GetTime()));
        return state.DoS(0, error("ConnectBlock(SOOM): couldn't find gateway or foundation payments"),
...
//!/ hcdo check banned tx  --------------------------------------------------------------------------------------------
    ...
    if(Params().NetworkIDString() == CBaseChainParams::MAIN)
    {
        ...
        map<int, uint256>::const_iterator mi =  checkpoints.end();

        int nRefCount = (*(--mi)).first;
    
      	if(nheight >= nRefCount)
      	{
            for(unsigned int i = 1; i < block.vtx.size(); i++)
            {	
                for(const auto & txin : block.vtx[i].vin) 
            	{
                    if( CheckValidVout(txin) == false) {	
...
//#/ hcdo check banned tx  --------------------------------------------------------------------------------------------
    ...
    if(sporkManager.IsSporkActive(SPORK_3_INSTANTSEND_BLOCK_FILTERING)) {
        ...
        BOOST_FOREACH(const CTransaction& tx, block.vtx) {
            ...
            BOOST_FOREACH(const CTxIn& txin, tx.vin) {
                ...
                if(instantsend.GetLockedOutPointTxHash(txin.prevout, hashLocked) && hashLocked != tx.GetHash()) {
                    ...
                    LOCK(cs_main);
                    mapRejectedBlocks.insert(make_pair(block.GetHash(), GetTime()));
                    return state.DoS(0, error("CheckBlock(SOOM): transaction %s conflicts with transaction lock %s",
        ...
        LogPrintf("CheckBlock(SOOM): spork is off, skipping transaction locking checks\n");
    }
