...
// U+201A SINGLE LOW-9 "QUOTATION MARK = UTF-8 E2 80 9A
...
#define THIN_SP_HTML REAL_THIN_SP_HTML  //HTML_HACK_SP

/** Soom unit definitions. Encapsulates parsing and formatting
