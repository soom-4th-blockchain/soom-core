...
static int column_alignments[] = {
        Qt::AlignHCenter|Qt::AlignVCenter, /* status */
        Qt::AlignHCenter|Qt::AlignVCenter, /* watchonly */
        Qt::AlignHCenter|Qt::AlignVCenter, /* date */
        Qt::AlignHCenter|Qt::AlignVCenter, /* type */
        Qt::AlignHCenter|Qt::AlignVCenter, /* address */
