    ...
    mapper(0)
{
    ...
    ui->theme->addItem(QString("SOOM-gray"), QVariant("default"));
...
void OptionsDialog::setModel(OptionsModel *_model)
{
    ...
    /* Wallet */
    connect(ui->showGatewaysTab, SIGNAL(clicked(bool)), this, SLOT(showRestartWarning()));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->showGatewaysTab, OptionsModel::ShowGatewaysTab);
