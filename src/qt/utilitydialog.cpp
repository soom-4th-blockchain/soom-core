    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Soom Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Soom Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  soom-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Soom Core is shutting down...") + "<br /><br />" +
