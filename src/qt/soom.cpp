...
{
    return QCoreApplication::translate("soom-core", psz).toStdString();
}
...
static void initTranslations(QTranslator &qtTranslatorBase, QTranslator &qtTranslator, QTranslator &translatorBase, QTranslator &translator)
{
    ...
    // Load e.g. bitcoin_de.qm (shortcut "de" needs to be defined in soom.qrc)
...
/** Class encapsulating Soom Core startup and shutdown.
...
int main(int argc, char *argv[])
{
    ...
    Q_INIT_RESOURCE(soom);
    Q_INIT_RESOURCE(soom_locale);
    ...
    // soom: links repeatedly have their payment requests routed to this process:
