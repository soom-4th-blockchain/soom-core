    ...
    platformStyle(platformStyle)
{
    ...
    signVerifyMessagePage = new SignVerifyMessageDialog(platformStyle, this);
    usedSendingAddressesPage = new AddressBookPage(platformStyle, AddressBookPage::ForEditing, AddressBookPage::SendingTab, AddressBookPage::Close, this);
...
//    addWidget(usedReceivingAddressesPage);
    ...
    if (settings.value("fShowGatewaysTab").toBool()) {
        gatewayListPage = new GatewayList(platformStyle);
        addWidget(gatewayListPage);
    }
...
void WalletView::setClientModel(ClientModel *clientModel)
{
    ...
    QSettings settings;
    if (settings.value("fShowGatewaysTab").toBool()) {
        gatewayListPage->setClientModel(clientModel);
    }
}
...
void WalletView::setWalletModel(WalletModel *walletModel)
{
    ...
    QSettings settings;
    if (settings.value("fShowGatewaysTab").toBool()) {
        gatewayListPage->setWalletModel(walletModel);
    }
    receiveCoinsPage->setModel(walletModel);
    sendCoinsPage->setModel(walletModel);
    usedReceivingAddressesPage->setModel(walletModel->getAddressTableModel());
    usedReceivingAddressesPage->setOptionsModel(walletModel->getOptionsModel());
...
void WalletView::gotoGatewayPage()
{
    QSettings settings;
    if (settings.value("fShowGatewaysTab").toBool()) {
        setCurrentWidget(gatewayListPage);
    }
}
...
//        signVerifyMessageDialog->setAddress_SM(addr);
    ...
    if (!addr.isEmpty())
        signVerifyMessagePage->setAddress_SM(addr);
}
...
//        signVerifyMessageDialog->setAddress_VM(addr);
    ...
    if (!addr.isEmpty())
        signVerifyMessagePage->setAddress_VM(addr);
}

void WalletView::gotoUsedSendingAddressesPage()
{
    setCurrentWidget(usedSendingAddressesPage);
}

void WalletView::gotoUsedReceivingAddressesPage()
{
