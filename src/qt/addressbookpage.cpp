    ...
    btn(btn)
{
    ...
    ui->showQRCode->setVisible(false);  // default

    switch(tab)
    {
    case SendingTab:
        ui->labelExplanation->setText(tr("These are your Soom addresses for sending payments. Always check the amount and the receiving address before sending coins."));
        ui->deleteAddress->setVisible(true);
//        ui->showQRCode->setVisible(false);
        break;
    case ReceivingTab:
        ui->labelExplanation->setText(tr("These are your Soom addresses for receiving payments. It is recommended to use a new receiving address for each transaction."));
        ui->deleteAddress->setVisible(false);
        switch(btn)
        {
        case Close: ui->showQRCode->setVisible(true); break;
        case Choose: break;
        }
        break;
    }
    ...
    else if(tab == ReceivingTab && btn == Close)
