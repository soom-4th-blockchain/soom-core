    ...
    platformStyle(platformStyle)
{
    ...
    ui->pasteButton_SM->setIcon(QIcon(":/icons/" + theme + "/drkblue_editcopy"));
    ui->copySignatureButton_SM->setIcon(QIcon(":/icons/" + theme + "/drkblue_editcopy"));
    ui->addressBookButton_VM->setIcon(QIcon(":/icons/" + theme + "/drkblue_address-book"));
...
void SignVerifyMessageDialog::on_addressBookButton_SM_clicked()
{
    ...
    {
        AddressBookPage dlg(platformStyle, AddressBookPage::ForSelection, AddressBookPage::ReceivingTab, AddressBookPage::Choose, this);
...
void SignVerifyMessageDialog::on_addressBookButton_VM_clicked()
{
    if (model && model->getAddressTableModel())
    {
        AddressBookPage dlg(platformStyle, AddressBookPage::ForSelection, AddressBookPage::SendingTab, AddressBookPage::Choose, this);
        dlg.setModel(model->getAddressTableModel());
        if (dlg.exec())
        {
