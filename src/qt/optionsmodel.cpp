...
void OptionsModel::Init(bool resetSettings)
{
    ...
    if (!settings.contains("fShowGatewaysTab"))
        settings.setValue("fShowGatewaysTab", gatewayConfig.getCount());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in soom.cpp during shotdown to also remove the window positions
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case ShowGatewaysTab:
            return settings.value("fShowGatewaysTab");
        case LowKeysWarning:
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case SpendZeroConfChange:
            ...
            break;
        case ShowGatewaysTab:
            if (settings.value("fShowGatewaysTab") != value) {
                settings.setValue("fShowGatewaysTab", value);
                setRestartRequired(true);
            }
            break;
        case LowKeysWarning:
