...
//        QString address = "<span style='font-family: monospace;'>" + rcp.address;
        QString address = "<span style='color:#4875b4;'>" + rcp.address;
        address.append("</span>");
    ...
    confirmationDialog.button(QMessageBox::Cancel)->setStyleSheet(QString("background-color:#ffffff; color:#4E586D;"));
...
void SendCoinsDialog::coinControlChangeEdited(const QString& text)
{
    if (model && model->getAddressTableModel())
    {
        ...
        {
            ui->labelCoinControlChangeLabel->setText(tr("Warning: Invalid Soom address"));
        }
        else // Valid address
        {
            CKeyID keyid;
