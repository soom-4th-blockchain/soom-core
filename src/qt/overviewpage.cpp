...
public:
    TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(BitcoinUnits::SOOM),
    ...
    txdelegate(new TxViewDelegate(platformStyle, this))
{
    ...
    // Note: minimum height of listTransactions will be set later to reflect actual settings
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    {
        // update the display unit, to not use the default ("SOOM")
        updateDisplayUnit();
