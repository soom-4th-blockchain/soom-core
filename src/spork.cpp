...
std::map<int, int64_t> mapSporkDefaults = {
    ...
    {SPORK_5_INSTANTSEND_MAX_VALUE,          5000},          // 5000 SOOM
    {SPORK_6_NEW_SIGS,                       4070908800ULL}, // OFF
    {SPORK_8_GATEWAY_PAYMENT_ENFORCEMENT,    4070908800ULL}, // OFF
    {SPORK_10_GATEWAY_PAY_UPDATED_NODES,     4070908800ULL}, // OFF
    {SPORK_12_RECONSIDER_BLOCKS,             0},             // 0 BLOCKS
    {SPORK_14_REQUIRE_SENTINEL_FLAG,         4070908800ULL}, // OFF
    {SPORK_15_DETERMINISTIC_GWS_ENABLED,     4070908800ULL}, // OFF
...
int CSporkManager::GetSporkIDByName(const std::string& strName)
{
    ...
    if (strName == "SPORK_8_GATEWAY_PAYMENT_ENFORCEMENT")       return SPORK_8_GATEWAY_PAYMENT_ENFORCEMENT;
    if (strName == "SPORK_10_GATEWAY_PAY_UPDATED_NODES")        return SPORK_10_GATEWAY_PAY_UPDATED_NODES;
    if (strName == "SPORK_12_RECONSIDER_BLOCKS")                return SPORK_12_RECONSIDER_BLOCKS;
    if (strName == "SPORK_14_REQUIRE_SENTINEL_FLAG")            return SPORK_14_REQUIRE_SENTINEL_FLAG;
    if (strName == "SPORK_15_DETERMINISTIC_GWS_ENABLED")        return SPORK_15_DETERMINISTIC_GWS_ENABLED;
...
std::string CSporkManager::GetSporkNameByID(int nSporkID)
{
    switch (nSporkID) {
        ...
        case SPORK_8_GATEWAY_PAYMENT_ENFORCEMENT:       return "SPORK_8_GATEWAY_PAYMENT_ENFORCEMENT";
        case SPORK_10_GATEWAY_PAY_UPDATED_NODES:        return "SPORK_10_GATEWAY_PAY_UPDATED_NODES";
        case SPORK_12_RECONSIDER_BLOCKS:                return "SPORK_12_RECONSIDER_BLOCKS";
        case SPORK_14_REQUIRE_SENTINEL_FLAG:            return "SPORK_14_REQUIRE_SENTINEL_FLAG";
        case SPORK_15_DETERMINISTIC_GWS_ENABLED:        return "SPORK_15_DETERMINISTIC_GWS_ENABLED";
