...
bool CSporkManager::IsSporkActive(int nSporkID)
{
    ...
    if(mapSporksActive.count(nSporkID)){
        ...
        switch (nSporkID) {
            ...
            case SPORK_8_GATEWAY_PAYMENT_ENFORCEMENT:    r = SPORK_8_GATEWAY_PAYMENT_ENFORCEMENT_DEFAULT; break;
            case SPORK_10_GATEWAY_PAY_UPDATED_NODES:     r = SPORK_10_GATEWAY_PAY_UPDATED_NODES_DEFAULT; break;
...
int64_t CSporkManager::GetSporkValue(int nSporkID)
{
    ...
    switch (nSporkID) {
        ...
        case SPORK_8_GATEWAY_PAYMENT_ENFORCEMENT:    return SPORK_8_GATEWAY_PAYMENT_ENFORCEMENT_DEFAULT;
        case SPORK_10_GATEWAY_PAY_UPDATED_NODES:     return SPORK_10_GATEWAY_PAY_UPDATED_NODES_DEFAULT;
